...
-- Kill/restart
create_bind("CTRL + SUPER + SHIFT + R", hl.dsp.exec_cmd("systemctl --user stop cortetsu-shell.service"), release)
create_bind(
    "CTRL + SUPER + ALT + R",
    hl.dsp.exec_cmd("systemctl --user restart cortetsu-shell.service"),
    release
)
