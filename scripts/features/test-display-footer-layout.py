...
assert 'text: qsTr("Plan de prueba")' in editor
assert 'text: qsTr("Aplicar de forma segura")' in (root / "cortetsu/modules/display/PreviewControls.qml").read_text(encoding="utf-8")
