...
assert 'tooltipText: qsTr("Modo de pantalla anterior")' in editor
assert 'tooltipText: qsTr("Reducir %1").arg(modelData.label)' in editor
assert 'label: planner.running ? qsTr("Validando…") : qsTr("Probar propuesta")' in editor
